...
"""
    This module is placed just after the Graph Attention network (GAT)
"""
...
class CustomizedEmbedding(nn.Module):
    """
    This module constructs the initial embeddings for the graph neural network forward pass
    """
